    ...
    <div className="bg-black text-white py-3 px-4 relative">
      <div className="container mx-auto flex items-center justify-center gap-4">
        <div className="flex items-center gap-2">
          <div className="bg-red-600 text-white px-3 py-1 rounded text-xs font-bold uppercase">Operação</div>
          <span className="text-2xl font-bold">BLACK FRIDAY</span>
        </div>
        <span className="text-sm">
          Receba notificações em tempo real <span className="font-semibold">da Black Friday</span>
        </span>
